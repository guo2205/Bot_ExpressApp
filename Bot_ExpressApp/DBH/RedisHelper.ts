...
export class Redis
{
    ...
    //存入一段字符串如果key有就覆盖
    public SetString(key: any, value: any, fun?: ResCallbackT<any>)
    {
    ...
    //-----------------------------------------------list 的操作
    //存入数据---默认往上存
    public SetItemToList(key: any, value: any, fun?: ResCallbackT<any>) {
        this.RC.lpush(key, value, fun);
    }
    //存入数据---往上存
    public SetItemToList_Left(key: any, value: any, fun?: ResCallbackT<any>)
    {
        this.RC.lpush(key, value, fun);
    }
    //存入数据---往下存
    public SetItemToList_Right(key: any, value: any, fun?: ResCallbackT<any>) {
    ...
    //-----------------------------------------------Hash 的操作
    //存入一条数据
    public SetItemToHash(key: any, fieldKey: any, fieldValue, fun?: ResCallbackT<any>)
    {
        this.RC.hset(key, fieldKey, fieldValue, fun);
    }
    //存入很多数据 -----要改
    public SetItemsToHash(key: any, field: { fieldKey: any, fieldValue: any }[], string, fun?: ResCallbackT<any>)
    {
